...
static SceIoDevice uma_ux0_dev = { "imc0:", "exfatux0", "sdstor0:gcd-lp-ign-entire ", "sdstor0:gcd-lp-ign-entire", MOUNT_POINT_ID };
...
int module_start(SceSize args, void *argp) {
	...
	register_sysevent();
	redirect_ux0();
//  ksceIoUmount(0x900, 0, 0, 0);
 	//ksceIoMount(0x900, NULL, 2, 0, 0, 0);
